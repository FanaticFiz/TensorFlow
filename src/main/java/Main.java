...
public class Main extends Application {
	...
	final String PATH_TO_DATA_DIR = "/opt/source/";
	...
	public void start(Stage stage) throws Exception {
		this.stage = stage;
		Path path = Paths.get(PATH_TO_DATA_DIR, "imagenet_comp_graph_label_strings.txt");

		List<String> labels = Files.lines(path).collect(Collectors.toList());
